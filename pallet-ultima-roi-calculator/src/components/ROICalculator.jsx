...
import { exportROIWithTemplate } from '../utils/exportROIWithTemplate';
import { exportROIAdaptive } from '../utils/exportROIAdaptive';
import { exportROIOverlay } from '../utils/exportROIOverlay';
...
//   if (!results) return;
//   await exportROIAdaptive(results, narrative);
// };
  // // Use the TEMPLATE export for the branded PDF
  // const handleExportPDF = async () => {
  //   if (!results) return;
  //   await exportROIWithTemplate(results, narrative);
  // };
const handleExportPDF = async () => {
  if (!results) return;
  await exportROIOverlay(results, narrative);
};
